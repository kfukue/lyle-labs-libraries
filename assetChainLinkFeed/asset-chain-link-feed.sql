...
CREATE TABLE IF NOT EXISTS asset_chain_link_data_feed (
...
CREATE INDEX asset_chain_link_data_feed_asset_id ON asset_chain_link_data_feed(asset_id);
CREATE INDEX asset_chain_link_data_feed_chain_id ON asset_chain_link_data_feed(chain_id);
